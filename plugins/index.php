...
if (stristr($_SERVER['SCRIPT_NAME'], '/plugins/index.php'))
    die('Access Denied');
	...
	else 
	{
        ...
        if ($form['type'] == 'CONFIG') 
		{
            ...
            foreach ($data as $key => $value) 
			{
				...
				{
					$saveform .= '<input style="width: 99%; height: 24px; font-family: courier new, monospace; font-size: 15px; color: #444;" name="' . $pluginloader_cfg['form_namespace'] . $key . '" value="' . htmlspecialchars($value, ENT_NOQUOTES, 'UTF-8') . '" />';
				}
