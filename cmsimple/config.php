<?php
/* utf8-marker = äöüß */
$cf['security']['password']="\$P\$Bu13OLYv0SfahFybsemWFJ4EKEySaL1";
$cf['security']['type']="page";
$cf['site']['title']="mzExtract";
...
$cf['meta']['keywords']="mzExtract";
$cf['meta']['description']="mzExtract";
$cf['meta']['author']="";
$cf['meta']['publisher']="";
$cf['mailform']['email']="";
...
$cf['filebrowser']['show_images_permanent']="true";
$cf['filebrowser']['maxheight_of_thumbs']="86";
$cf['filebrowser']['width_px_plus']="32";
$cf['jquery']['autoload']="";
$cf['jquery']['file_css']="smoothness/jqueryui.css";
$cf['jquery']['file_core']="jquery-1.10.1.min.js";
$cf['jquery']['file_ui']="jquery-ui-1.10.1.custom.min.js";
